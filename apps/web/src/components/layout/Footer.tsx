 ...
 * 
 * Displays footer content with navigation links and social media icons.
 * Appears at the bottom of every page via MainLayout.
 * 
 * @component
 * 
 * Features:
 * - Shop links (Products, New Arrivals, Sale)
 * - Support links (Contact, FAQs, Shipping)
 * - Company links (About, Careers, Privacy)
